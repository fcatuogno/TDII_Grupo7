...
#ifndef PROJECTS_TEST_MPU6050_INC_MPU6050_H_
#define PROJECTS_TEST_MPU6050_INC_MPU6050_H_
...
typedef struct
{
	uint8_t read_buffer_accel[6];
	uint8_t read_buffer_giro[6];
	int16_t buffer_gral[6];
} values_mpu;
...
void MPU6050_GetAngle(values_mpu*,angulos_mpu *,float);


#endif /* PROJECTS_TEST_MPU6050_INC_MPU6050_H_ */
